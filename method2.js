...
const transferToken = async(toAccount, amount) => {
    ...
    tx.sign(privateKey);
    console.log("Signed transcation with super key")

    const serializedTx = tx.serialize();
    const raw = '0x' + serializedTx.toString('hex')
    console.log("About to send the transaction " + raw)
    let txHash = await sendTx(raw);
    console.log("transaction hash: " +txHash.transactionHash)
    console.log("Transaction from block: " + txHash.blockNumber)
}


module.exports = { transferToken }
//transferToken("0xFbC8857d46223C39C48BA844c5AB0159EA3B8692", 50);
